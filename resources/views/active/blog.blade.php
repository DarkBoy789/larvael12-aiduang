        ...
        <div class="row gy-5">
          ...
          <div class="col-lg-4 col-md-6">
            ...
            <article>
              ...
              <div class="meta-top">
                <ul>
                  <li class="d-flex align-items-center"><a href="blog-details">Fashion</a></li>
                  <li class="d-flex align-items-center"><i class="bi bi-dot"></i> <a href="blog-details"><time datetime="2022-01-01">Jan 1, 2022</time></a></li>
                </ul>
              </div>
          ...
          <div class="col-lg-4 col-md-6">
            ...
            <article>
              ...
              <div class="meta-top">
                <ul>
                  <li class="d-flex align-items-center"><a href="blog-details">Laws</a></li>
                  <li class="d-flex align-items-center"><i class="bi bi-dot"></i> <a href="blog-details"><time datetime="2022-01-01">Jul 5, 2022</time></a></li>
                </ul>
              </div>
